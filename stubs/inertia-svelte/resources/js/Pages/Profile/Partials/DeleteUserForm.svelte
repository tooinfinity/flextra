<script>
    ...
    import DangerButton from '@auth/Components/DangerButton.svelte'
    import InputError from '@auth/Components/InputError.svelte'
    import InputLabel from '@auth/Components/InputLabel.svelte'
    import Modal from '@auth/Components/Modal.svelte'
    import SecondaryButton from '@auth/Components/SecondaryButton.svelte'
