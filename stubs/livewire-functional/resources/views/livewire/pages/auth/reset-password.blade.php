...
<div>
    <form wire:submit="resetPassword">
        ...
        <div>
            ...
            <x-{{moduleNameLower}}::text-input wire:model="email" id="email" class="block mt-1 w-full" type="email" name="email" required autofocus autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-{{moduleNameLower}}::text-input wire:model="password" id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="new-password" />
